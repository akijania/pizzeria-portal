  ...
  render(){
    return (
      <nav>
        ...
        <NavLink to={`${process.env.PUBLIC_URL}/tables/booking`} activeClassName='active'>Tables booking</NavLink>
        <NavLink to={`${process.env.PUBLIC_URL}/tables/event`} activeClassName='active'>Tables event</NavLink>
        <NavLink to={`${process.env.PUBLIC_URL}/waiter`} activeClassName='active'>Waiter</NavLink>
        <NavLink to={`${process.env.PUBLIC_URL}/waiter/order`} activeClassName='active'>Waiter order</NavLink>
