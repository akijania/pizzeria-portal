  ...
  render(){
    return (
      <nav className={styles.component}>
        ...
        <Button className={styles.link} component={NavLink} to={`${process.env.PUBLIC_URL}/tables/booking`} activeClassName='active'>Tables booking</Button>
        <Button className={styles.link} component={NavLink} to={`${process.env.PUBLIC_URL}/tables/event`} activeClassName='active'>Tables event</Button>
