...
import styles from './NewBookedEvent.module.scss';
...
const NewBookedEvent = () => {
  ...
  const handleChangeRepeat = (event) => {
    setDaily({ ...daily, [event.target.name]: event.target.checked });
  };

  return (
    <Paper className={styles.component}>
      <h2 className={styles.title}>New event booking</h2>
